	    	...
	    	try {
				...
				Scanner scanLines = new Scanner (filePath); 
	            	...
	            	while ((LINE = br.readLine()) != null) {
		            	...
		            	System.out.println(tabSpace);
		            	System.out.println(tabSpace + minorCR47 + "Item: " + c_Green + val[1] + c_Reset);
		            	System.out.println(tabSpace + minorCR47 + "Quantity: " + c_Green + val [2] + c_Reset);
		            	System.out.println(tabSpace + minorCR47 + "Price: " + c_Green + val [3] + c_Reset);
		            	
		            	String newQuant = val [2];
		            	Double nQuantity = Double.parseDouble(newQuant);
		            	
		            	String newPrice = val [4];
		            	Double nPrice = Double.parseDouble(newPrice);
		            	System.out.println(tabSpace + minorCR47 + "Total Amount: " + c_Green + mths.currency.format(nQuantity * nPrice) + c_Reset);

		            	System.out.println(tabSpace + minorCR47 + "Group: " + c_Green + val [5] + c_Reset);
		            	System.out.println(tabSpace + minorCR47 + "Time Log: " + c_Green + wB [3] + c_Reset);
		            	System.out.println(tabSpace + minorCR47 + "Date Log: " + c_Green + wB [0] + " " + wB [1] + " " + wB [2] + ", " + wB [5] + c_Reset);
						}
						br.close();
            		}
